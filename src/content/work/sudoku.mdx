...
image: {
src: "/assets/images/sudoku-app.jpg",
...
and left border (I actually used box-shadows due to the way I formated my grid). When cells are orthogonally adjacent,
